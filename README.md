...
|  Flyway (V24) |                              |  Tokens / Rate|            |  Llama 3.1 70B|
...
- **Dual Engine Output & Single-Page Fit**:
  ...
  - Exact A4 PDF export powered by Flying Saucer with Roboto font embedding for universal Cyrillic glyph support and single-page / multi-page toggle.
