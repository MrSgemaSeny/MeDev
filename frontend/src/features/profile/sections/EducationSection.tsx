  ...
  return (
    <div className="max-w-2xl pl-0 sm:pl-6">
      <div className="flex justify-between items-center mb-4">
        ...
        {editingId === null && (
          <Button size="sm" variant="secondary" className="min-h-[44px]" onClick={() => setEditingId('new')}>Add education</Button>
        )}
      </div>
      <SortableList
        items={educationList}
    ...
    <Card className="p-4">
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex items-center gap-2 min-h-[44px]">
          ...
          <Label htmlFor="isCurrent" className="mb-0 cursor-pointer">I currently study here</Label>
        </div>
