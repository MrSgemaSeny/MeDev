    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="reg-email" className="block text-xs font-medium mb-1" style={{ color: 'var(--color-text-secondary)' }}>
              Email
            </label>
            <Input
              id="reg-email"
          ...
          <div>
            <label htmlFor="reg-username" className="block text-xs font-medium mb-1" style={{ color: 'var(--color-text-secondary)' }}>
              Username
            </label>
            <Input
              id="reg-username"
          ...
          <div>
            <label htmlFor="reg-password" className="block text-xs font-medium mb-1" style={{ color: 'var(--color-text-secondary)' }}>
              Password
            </label>
            <Input
              id="reg-password"
