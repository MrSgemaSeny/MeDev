...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Да. Мы генерируем стандартные векторные PDF через движок Flying Saucer + Thymeleaf. В них нет многослойных SVG, разрывов таблиц или скрытых шрифтов, поэтому ATS и HR-системы (Workday, Greenhouse, Lever, hh.kz) корректно считывают структурированный текст.',
  },
  {
