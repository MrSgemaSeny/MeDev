    ...
    <section id="templates" className="border-b border-[#30363d] bg-[#0d1117] py-10 sm:py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#f0f6fc]">
            6 инженерных форматов для любых требований
          </h2>
          <p className="mt-2 text-xs sm:text-base text-[#8b949e]">
            Каждый шаблон оптимизирован под ATS и доступен бесплатно в 1 клик.
          </p>
        </div>

        {/* Templates 2-column Grid */}
        <div className="mt-8 sm:mt-12 grid grid-cols-2 gap-2.5 sm:gap-4 lg:gap-6">
          {templates.map((tpl) => (
            <div
              key={tpl.id}
            ...
            >
              ...
              <div className="mt-2.5 sm:mt-4 pt-2 sm:pt-3 border-t border-[#30363d]">
                <Link
                  to="/login"
                  className="flex min-h-[40px] sm:min-h-[44px] items-center justify-center gap-1 sm:gap-1.5 rounded-lg border border-[#30363d] bg-[#21262d] px-2 py-1.5 sm:px-3 sm:py-2 text-[11px] sm:text-xs font-semibold text-[#c9d1d9] transition-colors hover:bg-[#30363d] hover:text-white"
                >
                  <span>Выбрать</span>
