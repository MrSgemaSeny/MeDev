...
export const ProfileEditor = () => {
  ...
  const handleSmartSync = async () => {
    toast.loading('AI is rewriting your entire profile...', { id: 'ai-sync' });
    try {
      await generateProfile();
      toast.success('Profile synced successfully!', { id: 'ai-sync' });
    } catch (e: any) {
    ...
    <div className="max-w-[1100px] mx-auto w-full p-8">
      <div className="flex justify-end mb-6">
        ...
        >
          ...
          {isPending ? 'Merging PDF & GitHub...' : 'Smart AI Sync'}
        </Button>
      </div>
      {renderActiveSection()}
    </div>
