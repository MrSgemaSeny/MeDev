      ...
      <main id="main-content" className="flex-1 py-10 sm:py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <Shield className="h-7 w-7 sm:h-8 sm:w-8 text-[#2ea043] shrink-0" aria-hidden="true" />
            <h1 className="text-2xl sm:text-3xl font-extrabold text-[#f0f6fc] break-words">Политика конфиденциальности</h1>
          </div>
